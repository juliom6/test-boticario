...
def contatoView(request):
    if request.method == 'GET':
        ...
        return HttpResponse('<h2>Obrigado ' + nome + '!!</h2><br /><h4>Recebimos sua requisição GET.</h4>', content_type='text/html', status=201)
    ...
    if request.method == 'POST':
        ...
        return HttpResponse('<h2>Obrigado ' + nome + '!!</h2><br /><h4>Recebimos sua requisição POST.</h4>', content_type='text/html', status=201)
